...
def generate_sigma_rule():
    ...
    yaml_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "yaml")
...
def generate_sigma_domains_rule():
    ...
    api_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "website", "public", "api")
...
| `detect_remote_access_software_usage_traffic_filter`""",
    ...
    output_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "detections", "splunk")
    os.makedirs(output_dir, exist_ok=True)
...
| summarize arg_max(TimeGenerated, *) by DeviceId""",
    ...
    output_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "detections", "kql")
    os.makedirs(output_dir, exist_ok=True)
...
def count_rmm_tools():
    ...
    output_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "website", "public", "api")
