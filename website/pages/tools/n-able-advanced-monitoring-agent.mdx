...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["remote.management", "*.remote.management", "*.logicnow.com", "systemmonitor.us", "*.systemmonitor.us", "systemmonitor.eu.com", "*.systemmonitor.eu.com", "system-monitor.com", "*.system-monitor.com", "systemmonitor.us.cdn.cloudflare.net", "cloudbackup.management", "*.cloudbackup.management", "systemmonitor.co.uk", "*.systemmonitor.co.uk", "*.n-able.com", "beanywhere.com", "*.beanywhere.com", "*.swi-tc.com"], "Ports": []}] }/>
