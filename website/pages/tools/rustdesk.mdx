...
#### Installation Paths
<Card code={ ["rustdesk*.exe", "rustdesk.exe"] }/>
...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["rustdesk.com", "user_managed", "web.rustdesk.com"], "Ports": []}] }/>
