...
<BlockBanner name={"Distant Desktop"}/>
...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["*.distantdesktop.com", "signalserver.xyz", "*.signalserver.xyz"], "Ports": []}] }/>
