...
#### Disk Artifacts
<EuiSpacer size="xl"/>
<DiskArtifacts data={ [{"File": "C:\\Program Files\\Level\\level.exe", "Description": "Level Binary"}, {"File": "C:\\Program Files\\Level\\osqueryi.exe", "Description": "A tool used by level to collect machine state information."}, {"File": "C:\\Program Files\\Level\\level.log", "Description": "Client log file for Level."}] }/>
