...
#### Installation Paths
<Card code={ ["support-logmeinrescue*.exe", "support-logmeinrescue.exe", "lmi_rescue.exe"] }/>
...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["*.logmeinrescue.com", "*.logmeinrescue.eu", "logmeinrescue.com"], "Ports": []}] }/>
