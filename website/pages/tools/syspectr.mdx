...
#### Installation Paths
<Card code={ ["oolocker.exe", "oosyspectr.exe", "syspectr.exe"] }/>
...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["*.syspectr.com", "syspectr.com"], "Ports": []}] }/>
...
### References
- [https://syspectr.com](https://syspectr.com)
