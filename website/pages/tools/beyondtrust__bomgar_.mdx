...
#### Installation Paths
<Card code={ ["bomgar-scc.exe", "bomgar-rdp.exe", "bomgar-scc-*.exe", "bomgar-pac-*.exe", "bomgar-pac.exe"] }/>
...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["bomgarcloud.com", "*.bomgarcloud.com", "*.beyondtrustcloud.com"], "Ports": []}] }/>
