...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["deploy01.kaseya.com", "managedsupport.kaseya.net", "*.managedsupport.kaseya.net", "*.kaseya.net", "kaseya.com"], "Ports": []}] }/>
