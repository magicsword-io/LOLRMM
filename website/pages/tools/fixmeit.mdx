...
#### Network Artifacts
<EuiSpacer size="xl"/>
<NetworkArtifactsTable data={ [{"Description": "Known remote domains", "Domains": ["*.fixme.it", "*.techinline.net", "fixme.it", "set.me", "*.set.me", "setme.net", "*.setme.net"], "Ports": []}] }/>
