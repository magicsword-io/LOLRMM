...
### Detections
- **AteraAgent malicious installations**  Detects AteraAgent installations with suspicious command line arguments.
...
- **Atera Agent Installation**  Detects Atera Agent installation.
